...
interface TutoringConfigPanelProps {
  questionCount: number;
  onQuestionCountChange: (count: number) => void;
  onStart: () => void;
  isCreating: boolean;
  checkingUnfinished: boolean;
  unfinishedSession: TutoringSession | null;
    ...
    >
      <div className="bg-white rounded-2xl p-8 shadow-sm">
            ...
            >
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-amber-900 mb-1">检测到未完成的测验</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="mb-6">
            <label className="block text-sm font-semibold text-slate-600 mb-3">课程资料预览（前500字）</label>
            <textarea 
              value={studentProfileText.substring(0, 500) + (studentProfileText.length > 500 ? '...' : '')}
              readOnly
