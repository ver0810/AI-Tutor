...
interface TutoringChatPanelProps {
  session: TutoringSession;
  currentQuestion: TutoringQuestion | null;
  messages: Message[];
  answer: string;
      ...
      >
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            <span className="text-sm font-semibold text-slate-700">AI 助教</span>
            {message.category && (
