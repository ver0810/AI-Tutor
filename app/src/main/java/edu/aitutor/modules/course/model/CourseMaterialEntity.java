...
@Table(name = "course_materials", indexes = {
    ...
    @Index(name = "idx_kb_course", columnList = "courseId")
})
public class CourseMaterialEntity {
    ...
    @Column(length = 20)
    private MaterialVectorStatus vectorStatus = MaterialVectorStatus.PENDING;
    ...
    public MaterialVectorStatus getVectorStatus() {
        return vectorStatus;
    }

    public void setVectorStatus(MaterialVectorStatus vectorStatus) {
