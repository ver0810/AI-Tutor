...
@Table(name = "rag_chat_sessions", indexes = {
    ...
    @Index(name = "idx_rag_session_course", columnList = "courseId")
})
@Getter
@Setter
@NoArgsConstructor
public class TutorChatSessionEntity {
    ...
    private Set<CourseMaterialEntity> courseMaterials = new HashSet<>();
     ...
     * 便捷方法：添加消息
     */
    public void addMessage(TutorChatMessageEntity message) {
     ...
     * 便捷方法：获取知识库ID列表
     */
    public List<Long> getCourseMaterialIds() {
