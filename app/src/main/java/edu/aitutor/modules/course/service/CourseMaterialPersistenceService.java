...
public class CourseMaterialPersistenceService {
    ...
    public Map<String, Object> handleDuplicateCourseMaterial(CourseMaterialEntity kb, String fileHash) {
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    public CourseMaterialEntity saveCourseMaterial(MultipartFile file, Long courseId, String name, String category,
                                                  String storageKey, String storageUrl, String fileHash) {
        try {
            CourseMaterialEntity kb = new CourseMaterialEntity();
            ...
            CourseMaterialEntity saved = knowledgeBaseRepository.save(kb);
            log.info("知识库已保存: id={}, courseId={}, name={}, category={}, hash={}", saved.getId(), courseId, saved.getName(), saved.getCategory(), fileHash);
            return saved;
        } catch (Exception e) {
    ...
    public void updateVectorStatusToPending(Long kbId) {
        ...
        kb.setVectorStatus(MaterialVectorStatus.PENDING);
