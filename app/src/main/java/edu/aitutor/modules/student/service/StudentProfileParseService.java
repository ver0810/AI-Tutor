...
import edu.aitutor.infrastructure.file.ContentTypeDetectionService;
import edu.aitutor.infrastructure.file.DocumentParseService;
...
public class StudentProfileParseService {
     ...
     * @return 提取的文本内容
     */
    public String parseStudentProfile(MultipartFile file) {
     ...
     * @return 提取的文本内容
     */
    public String parseStudentProfile(byte[] fileBytes, String fileName) {
