 ...
 * 课程资料实体 (业务重构: 简历 → 课程资料)
 * 
 * 映射: 简历(studentProfile) → 课程资料(course material)
 * 字段: studentProfileText → contentText, analyzeStatus → processingStatus
 */
@Entity
@Table(name = "student_profiles", indexes = {
    @Index(name = "idx_profile_hash", columnList = "fileHash", unique = true),
    @Index(name = "idx_profile_course", columnList = "course_id")
})
public class StudentProfileEntity {
    ...
    public String getStudentProfileText() {
        return studentProfileText;
    }
    
    public void setStudentProfileText(String studentProfileText) {
