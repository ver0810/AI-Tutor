...
import edu.aitutor.common.config.StorageConfigProperties;
...
public class FileStorageService {
     ...
     * 上传简历文件
     */
    public String uploadStudentProfile(MultipartFile file) {
     ...
     * 删除简历文件
     */
    public void deleteStudentProfile(String fileKey) {
        deleteFile(fileKey);
    }
     ...
     * 上传课程资料文件
     */
    public String uploadCourseMaterial(MultipartFile file) {
        return uploadFile(file, "course_materials");
    }

    /**
     * 删除课程资料文件
     */
    public void deleteCourseMaterial(String fileKey) {
        deleteFile(fileKey);
    }
