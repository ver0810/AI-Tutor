package interview.guide.modules.student;

import interview.guide.common.annotation.RateLimit;
import interview.guide.common.result.Result;
import interview.guide.modules.student.model.StudentProfileDetailDTO;
import interview.guide.modules.student.model.StudentProfileListItemDTO;
import interview.guide.modules.student.service.StudentProfileDeleteService;
import interview.guide.modules.student.service.StudentProfileHistoryService;
import interview.guide.modules.student.service.StudentProfileUploadService;
...
public class StudentProfileController {
    ...
    public Result<Map<String, String>> health() {
        return Result.success(Map.of(
            "status", "UP",
            "service", "AI Interview Platform - StudentProfile Service"
        ));
    }
