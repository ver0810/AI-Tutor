...
public interface KnowledgeBaseRepository extends JpaRepository<KnowledgeBaseEntity, Long> {
     ...
     * 根据课程ID查找知识库
     */
    List<KnowledgeBaseEntity> findByCourseIdOrderByUploadedAtDesc(Long courseId);

    /**
     * 根据课程ID和向量化状态查找
     */
    List<KnowledgeBaseEntity> findByCourseIdAndVectorStatusOrderByUploadedAtDesc(Long courseId, VectorStatus vectorStatus);
}
